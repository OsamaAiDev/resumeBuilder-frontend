export const landingPageStyles = {
  ...
  featuresGrid:
    "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 mx-12",
  ...
  featureCardContent:
    "relative bg-gradient-to-br border border-white/50 p-6 sm:p-6 rounded-3xl hover:shadow-2xl transition-all group-hover:scale-105",
