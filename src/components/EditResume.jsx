...
const useResizeObserver = () => {
  const [size, setSize] = useState({ width: 0, heigh: 0 });
...
const EditResume = () => {
    ...
    switch (currentPage) {
      ...
      case "contact-info":
        ...
        if (!phone.trim() || !/^\d{11}$/.test(phone))
          errors.push("Valid 11-digit phone number is required");
        break;
  ...
  // delete func to delete any resume
  ...
  // fetch resume details using backend url
  ...
  // it helps in choosing preview as well as helps in downloading the resume also saves
  // the resume as image
