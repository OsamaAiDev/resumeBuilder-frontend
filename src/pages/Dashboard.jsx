...
const Dashboard = () => {
  ...
  // it will show completed or filled it with DO ++
  const fetchAllResumes = async () => {
    try {
      setLoading(true);
      const response = await axiosInstance.get(API_PATHS.RESUME.GET_ALL);
      // add completition percentage to each resumes
        ...
        {!loading && allResumes.length === 0 && (
          <div className={styles.emptyStateWrapper}>
            ...
            <p className={styles.emptyText}>
              You havn't created any resume yet.Start building your professional
